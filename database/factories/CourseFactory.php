...
class CourseFactory extends Factory
{
    public function definition(): array
    {
        ...
        return [
            ...
            'thumbnail' => null,
            'short_description' => ['en' => fake()->sentence(), 'ar' => fake()->sentence()],
            'description' => ['en' => fake()->paragraph(), 'ar' => fake()->paragraph()],
            'course_overview' => ['en' => fake()->paragraph(), 'ar' => fake()->paragraph()],
            'what_you_learn' => ['en' => fake()->paragraph(), 'ar' => fake()->paragraph()],
